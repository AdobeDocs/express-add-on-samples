...
export const CLIENT_ID = "App key";
export const SCOPE = "account_info.read files.metadata.read files.content.read";
export const CURRENT_USER_API_URL = "https://api.dropboxapi.com/2/users/get_current_account";
...
export const IMAGE_THUMBNAIL_URL = "https://content.dropboxapi.com/2/files/get_thumbnail_v2";
