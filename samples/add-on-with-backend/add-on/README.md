...
The dev server runs at **https://localhost:5241**. When you create a private link or publish your add-on, Adobe assigns a dedicated origin such as `https://abc123.wxp.adobe-addons.com`. You cannot set `API_BASE_URL` to `http://localhost:3001` — the browser blocks it (mixed content).
